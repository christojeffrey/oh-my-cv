...
export type RuleInline = (state: any, silent: boolean) => boolean;
export type RuleCore = (state: any) => void;
...
const processDef: RuleBlock = (state, startLine, endLine, silent) => {
...
const processRef: RuleInline = (state, silent) => {
...
const postProcessDef: RuleCore = (state) => {
